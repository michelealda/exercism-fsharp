...
let ``There can be more than one match``() =
    let rows = [ "Allegoric Alaskans;Blithering Badgers;win"; "Allegoric Alaskans;Blithering Badgers;win" ]
    let expected =
        [ "Team                           | MP |  W |  D |  L |  P"
...
let ``There can be more than one winner``() =
    let rows = [ "Allegoric Alaskans;Blithering Badgers;loss"; "Allegoric Alaskans;Blithering Badgers;win" ]
    let expected =
        [ "Team                           | MP |  W |  D |  L |  P"
