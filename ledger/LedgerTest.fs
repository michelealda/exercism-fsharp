...
let ``Empty ledger``() =
    ...
    let locale = "en-US"
    let entries = []
    let expected = "Date       | Description               | Change       "
...
let ``One entry``() =
    let currency = "USD"
    let locale = "en-US"
    let entries = [ mkEntry "2015-01-01" "Buy present" -1000 ]
...
let ``Overlong descriptions``() =
    let currency = "USD"
    let locale = "en-US"
    let entries = [ mkEntry "2015-01-01" "Freude schoner Gotterfunken" -123456 ]
...
let ``Dutch locale``() =
    let currency = "USD"
    let locale = "nl-NL"
    let entries = [ mkEntry "2015-03-12" "Buy present" 123456 ]
...
let ``Dutch negative number with 3 digits before decimal point``() =
    let currency = "USD"
    let locale = "nl-NL"
    let entries = [ mkEntry "2015-03-12" "Buy present" -12345 ]
